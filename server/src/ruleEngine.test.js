...
// ルール17（クリリン）: v2で「59または593と完全一致」から「表示文字列に"59"を含む」に一般化した。
// 59は素数で完全一致だと結果として出しにくいため、591〜599、1591〜1599、マイナス、
// 桁の途中に現れる場合(例:159)なども対象になる。
checkDisplay('rule17-kuririn-59', '50+9', [17], 'クリリンのことかーっ！！！');
checkDisplay('rule17-kuririn-593', '99*5+98', [17], 'クリリンのことかーっ！！！'); // 99*5+98=593（"59"を含む）
checkDisplay('rule17-kuririn-591', '99*6-3', [17], 'クリリンのことかーっ！！！'); // 99*6-3=591
checkDisplay('rule17-kuririn-159', '99+60', [17], 'クリリンのことかーっ！！！'); // 99+60=159（末尾に"59"）
checkDisplay('rule17-kuririn-negative59', '3-62', [17], 'クリリンのことかーっ！！！'); // 3-62=-59（マイナスでも発動）
checkDisplay('rule17-no-59-no-effect', '10+50', [17], '60'); // 60は"59"を含まないので発動しない
checkDisplay(
